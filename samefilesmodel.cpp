...
SameFilesModel::SameFilesModel() : QAbstractItemModel(nullptr), worker_thread(), unique_group(new Node("Unique files", QByteArray())), maxTime(0) {
    ...
    emit scan_directory("/home/rsbat");
}
